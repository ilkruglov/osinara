...
| Внешняя группа | Только `group` | `/workspace/group` | Без Bash, сети и persistent credentials; безопасные file tools и настраиваемый импорт UTF-8 TXT/MD/JSON/CSV/TSV из Telegram. |
