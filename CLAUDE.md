...
(`deepseek-v4-flash`) и пишется `AGENT_MODEL_ID_RETIRED`. Как выйдет релизный id V4.1, поменять
`config/agent-model-providers.json` и каталог. Канал вырезает утёкшую разметку вызова инструмента
