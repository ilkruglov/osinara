...
и эмодзи вне набора отправляет обычным сообщением из одного символа, а отказ Telegram 400/403 на
допустимый эмодзи канал тоже превращает в такое сообщение; лог `AGENT_TELEGRAM_REACTION_UNAVAILABLE`
несёт эмодзи и `providerDescription`.
