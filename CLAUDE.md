...
Предстоящие напоминания чата видит любой участник, приостановленные только их автор, а изменить и
удалить можно лишь своё. Доверенный путь до чужой зоны не достаёт: `requireReminderMutationAccess`
отклоняет scope `group`, а личный список его не показывает. Групповая проактивная доставка
