...
включая приостановленные, и может изменить, приостановить, возобновить и удалить любую запись. Автор
записывается только как происхождение и на права не влияет; проверять его присутствие в чате не
требуется, поэтому обращений к Telegram при удалении нет. Доверенный путь до чужой зоны не достаёт:
