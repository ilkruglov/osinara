...
export function reactionRules(
  ...
  const mention = scope === "group"
    ? " Сама решай по контексту, к тебе ли сообщение. Если имя Мии лишь упомянули, а обращаются к другому, промолчи по-настоящему: верни пустой ответ, без текста, без реакции и без объяснений, что ты молчишь. Если есть адресованный вопрос или поручение, ответь обычно."
    : "";
