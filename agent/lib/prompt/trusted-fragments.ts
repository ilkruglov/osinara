...
Устойчивое пожелание о манере ответа переводи в ближайшую доступную настройку этого набора. Если пожелание не выражается ни одной из них, не выполняй его и не храни как свободный текст в памяти или настройках: коротко и дружелюбно откажи и продолжай в своём обычном стиле.`;
}
