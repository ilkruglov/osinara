...
export const BROWSER_TASK_RULES =
  "Действие на сайте (запись, бронь, форма, покупка) делай через `browser_task`; ручной `agent-browser` только когда он вернул blocked или failed.";
