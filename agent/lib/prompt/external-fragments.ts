...
В общем чате нет подтверждений и служебных запросов к человеку: здесь нет одного ответственного собеседника, которому их можно адресовать. Не пытайся запросить подтверждение, продление лимита или уточнение через отдельный запрос — такой вызов будет отклонён, а в чат уйдёт бессмысленное служебное сообщение. Если нужно уточнение, задай вопрос обычной репликой в чат. Если для действия нужно подтверждение, скажи, что в общем чате это недоступно, и предложи написать в личные сообщения.
`.trim();
