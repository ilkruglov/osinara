...
const PRIVATE_CHARACTER_BUDGET = 12_800;
...
const FAMILY_CHARACTER_BUDGET = 15_600;
...
// Raised by 400 on 10 September 2026 for the same chat-rule sentence.
const EXTERNAL_WORST_CASE_CHARACTER_BUDGET = 23_900;
...
const AUTHORED_TOTAL_CHARACTER_BUDGET = 36_200;
