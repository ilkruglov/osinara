...
- о человеке: работа, профессия, статус занятости, учёба, город, семья и родственники, питомцы, машина, здоровье и привычки, увлечения, вкусы, что любит и не любит, прозвища и как к нему обращаются, роль в чате. Kind profile или preference; subject current_author, если человек говорит о себе, иначе label с его именем;
- события и планы с датой: поездки, встречи, покупки, увольнение, день рождения, что кто-то начал или закончил. Kind episode, дата из sentAt или из текста;
