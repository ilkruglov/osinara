...
- жизнь самого чата: постоянные шутки, роли участников, бывшие участники, как называют тебя, темы, которые здесь любят или избегают, договорённости о том, как здесь общаться, а также как здесь принято разговаривать: длина реплик, тон, что читают, а что пролистывают, как реагируют на длинные ответы и на подколки. Kind fact с \`subject.label\` "чат" и \`attribute\` ("амплуа участника", "правила общения", "как здесь принято"). Это нужно, чтобы быть своей в этом чате;
