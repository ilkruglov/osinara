...
// The same directive as `TELEGRAM_SILENT_DIRECTIVE` in telegram-progress.ts, spelled out here so the
// permanent rules do not pull the delivery module (tests mock it partially); the block test binds them.
const SILENT_DIRECTIVE = "<telegram-silent>";
